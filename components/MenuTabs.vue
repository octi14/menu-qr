          ...
          <div class="flex-1 space-y-2 min-w-0">
            <div class="flex items-start justify-between gap-4">
              <div class="flex-1 min-w-0">
                ...
                <p v-if="item.description" class="text-sm opacity-80 mt-1 line-clamp-2">
                  {{ item.description }}
                </p>
              </div>
              <div class="flex flex-col items-end gap-2 flex-shrink-0">
                <span
                  ...
                  class="text-xl sm:text-2xl font-bold tabular-nums whitespace-nowrap"
                ...
                <span
                  ...
                  class="inline-flex items-center rounded-full bg-amber-100 dark:bg-amber-900/30 px-2 py-1 text-xs font-medium text-amber-800 dark:text-amber-300"
                >
                  agotado
                </span>
              </div>
